...
public class IA_dIAblo : PokemonIA
{
	...
	[SerializeField] int pointsOnOffTypeAdvante;
	[SerializeField] int pointsOnKill;
	[SerializeField] int pointsOnKillWithPrio;
	[SerializeField] int pointsOnDefInmunity;
	[SerializeField] int pointsOnDefAdvantage;
	[SerializeField] int pointsOnDefDisadvantage;
